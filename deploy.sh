...
# Publica o site no usuario da maratona em ime.usp.br/~maratona/winter17
...
read USER
DEST=/home/gradmac/$USER/_temp_winter17/
...
ssh $USER "sudo -u maratona rsync $DEST /home/specmac/maratona/www/winter17 -r"
